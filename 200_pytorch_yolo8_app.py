...
# コマンドライン引数の設定
parser = argparse.ArgumentParser(description='Process an image using YOLOv8.')
parser.add_argument('--image_path', type=str, required=True, help='Path to the image file to process.')
...
def main():
    ...
    model_path = r"E:\Programing\20250405_object_recognition\0_Yolo\yolov8m-seg.pt"  # より大きなモデルを使用
    ...
    # 結果の保存
    output_path = "C:\Users\staa2\Downloads.yolo8_appjpg"
