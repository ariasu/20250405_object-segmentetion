...
model_path = os.path.join(os.path.dirname(sys.executable), 'yolov8m-seg.pt')  # より大きなモデルを使用
...
# 結果の保存
output_path = r"E:\Programing\20250405_object_recognition\Picuture\output_pytorch_yolo8.jpg"
